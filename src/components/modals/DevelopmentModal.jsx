...
const DevelopmentModal = ({ setIsOpenDevelopmentModal, title, videoserver }) => {
  return (
    <>
      <div
        className={s.darkBG}
        onClick={() => setIsOpenDevelopmentModal(false)}
      />
        ...
        <div className={s.modal}>
          ...
          <div className={s.modalContent}>
            ...
            <div className={s.modalBody}>
              <div className={s.modalBody_videoWrapper}>
              ...
              <div className={s.modalBody_info}>
                ...
                <div className={s.modalBody_information}>
                  ...
                  <div className={s.modalBody_information_item}>
                    <span>Видеосервер: </span>{videoserver.name}
                  </div>
                </div>
              </div>
            </div>
